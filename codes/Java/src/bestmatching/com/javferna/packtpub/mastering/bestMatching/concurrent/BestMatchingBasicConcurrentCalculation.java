...
//		List<Callable<BestMatchingData>> callables = new ArrayList<>();
...
//				endIndex = (i + 1) * step;
//			}
//			System.out.println("startIndex=" + startIndex + "-endIndex=" + endIndex + "-word=" + word);
...
//			results = executor.invokeAll(callables);
			Future<BestMatchingData> future = executor.submit(bmd);
			results.add(future);
		}
		executor.shutdown();
