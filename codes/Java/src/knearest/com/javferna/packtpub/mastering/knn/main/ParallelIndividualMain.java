...
import knearest.com.javferna.packtpub.mastering.knn.parallel.individual.KnnClassifierParallelIndividual;

/**
 * Main class that launches the tests using the fine-grained concurrent version
 * and serial sorting
 * 
 * @author author
 *
